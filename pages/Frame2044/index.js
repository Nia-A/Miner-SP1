...
const Frame2044Page = () => {
  ...
  const handleNavigate2 = () => navigate("/frame2045");

  return (
    <>
      <Column className="bg-gray_51 font-apercupro items-center justify-end mx-[auto] overflow-auto w-[100%]">
        <Stack className="3xl:h-[1103px] lg:h-[714px] xl:h-[817px] h-[918px] 2xl:h-[919px] w-[100%]">
          <div className="absolute bg-gray_51 3xl:h-[1046px] lg:h-[678px] xl:h-[775px] h-[871px] 2xl:h-[872px] top-[0] w-[100%]"></div>
          <Column className="absolute bottom-[0] inset-x-[0] items-center justify-start top-[1%] w-[100%]">
            <Stack className="3xl:h-[107px] lg:h-[70px] xl:h-[80px] h-[89px] 2xl:h-[90px] w-[100%]">
              <header className="absolute bottom-[0] w-[100%]">
              ...
              <Row className="absolute bg-gray_51 bottom-[0] font-alata inset-x-[0] items-center justify-end w-[100%]">
                ...
                <Image
                  src="img_bar_3.svg"
                  className="lg:h-[25px] xl:h-[29px] h-[32px] 2xl:h-[33px] 3xl:h-[39px] ml-[1089px] 3xl:ml-[1307px] lg:ml-[847px] xl:ml-[968px] xl:mr-[10px] mr-[12px] 3xl:mr-[14px] lg:mr-[9px] xl:my-[10px] my-[12px] 3xl:my-[14px] lg:my-[9px] object-contain w-[7%]"
                  alt="bar"
                />
              </Row>
            ...
            <Stack className="3xl:h-[106px] lg:h-[69px] xl:h-[79px] h-[88px] 2xl:h-[89px] w-[100%]">
              <Row className="absolute bg-gray_51 items-center justify-start top-[0] w-[100%]">
                <Image
                  ...
                  alt="icon24filter"
                />
                <Row className="items-center justify-center lg:ml-[6px] xl:ml-[7px] ml-[8px] 3xl:ml-[9px] lg:mr-[1022px] xl:mr-[1169px] mr-[1315px] 3xl:mr-[1578px] lg:my-[10px] xl:my-[11px] my-[13px] 3xl:my-[15px] w-[5%]">
                  <Image
              ...
              <Text className="absolute bg-gray_51 bottom-[0] font-medium leading-lh14000 lg:pl-[18px] xl:pl-[21px] pl-[24px] 3xl:pl-[28px] xl:py-[10px] py-[11.5px] 2xl:py-[11px] 3xl:py-[13px] lg:py-[8px] text-bluegray_201 xl:text-fs10 text-fs12 3xl:text-fs14 lg:text-fs9 text-left w-[100%]">
                <span className="text-bluegray_201 text-fs12 font-apercupro text-center font-normal lg:text-fs9 xl:text-fs10 3xl:text-fs14">
                  <>{`Showing `}</>
                </span>
                <span className="text-bluegray_702 text-fs12 font-apercupro text-center font-normal lg:text-fs9 xl:text-fs10 3xl:text-fs14">
                  <>{`198`}</>
                </span>
                <span className="text-bluegray_201 text-fs12 font-apercupro text-center font-normal lg:text-fs9 xl:text-fs10 3xl:text-fs14">
                  <>{` from `}</>
            ...
            <Row className="items-start justify-evenly xl:mt-[1px] lg:mt-[1px] mt-[2px] w-[100%]">
              <Stack className="lg:h-[514px] xl:h-[588px] h-[660px] 2xl:h-[661px] 3xl:h-[793px] lg:mb-[56px] xl:mb-[64px] mb-[72px] 3xl:mb-[86px] w-[61%]">
                <Stack className="absolute lg:h-[514px] xl:h-[588px] h-[660px] 2xl:h-[661px] 3xl:h-[793px] inset-[0] w-[100%]">
                        ...
                        <Stack className="lg:h-[28px] xl:h-[33px] h-[36px] 2xl:h-[37px] 3xl:h-[44px] w-[78%]">
                          <Column className="absolute inset-[0] items-start justify-start w-[100%]">
                            <Column className="items-center w-[100%]">
                              <Stack className="lg:h-[28px] xl:h-[33px] h-[36px] 2xl:h-[37px] 3xl:h-[44px] w-[100%]">
                                <Row className="absolute grid grid-cols-2 items-center justify-evenly left-[0] w-[67%]">
                                  <Text className="bg-deep_purple_A200_f5 font-normal lg:leading-lh12 xl:leading-lh14 2xl:leading-lh16 leading-lh1600 3xl:leading-lh19 not-italic lg:pl-[15px] xl:pl-[17px] pl-[20px] 3xl:pl-[24px] py-[10px] 3xl:py-[12px] lg:py-[7px] xl:py-[8px] text-bluegray_702 xl:text-fs10 text-fs12 3xl:text-fs14 lg:text-fs9 text-left w-[100%]">{`12`}</Text>
                                  <Column className="w-[100%]">
                                ...
                                <Column className="absolute items-start justify-start right-[0] w-[33%]">
                          ...
                          <Text className="absolute font-normal h-[max-content] inset-y-[0] my-[auto] not-italic right-[5%] text-bluegray_702 xl:text-fs10 text-fs12 3xl:text-fs14 lg:text-fs9 text-left">{`$115.50`}</Text>
                        </Stack>
                      </Row>
                      <Row className="items-center justify-evenly w-[100%]">
                        <Image
                  ...
                  <Stack className="absolute lg:h-[117px] xl:h-[134px] h-[150px] 2xl:h-[151px] 3xl:h-[181px] right-[13%] top-[6%] w-[53%]">
                    <Image
                      src="img_cardbody.svg"
                      className="absolute lg:h-[117px] xl:h-[134px] h-[150px] 2xl:h-[151px] 3xl:h-[181px] inset-[0] object-cover rounded-radius8 w-[100%]"
                      alt="cardbody"
                    />
                    <Row className="absolute bg-white_A700 bottom-[0] items-center justify-end rounded-bl-[16px] rounded-br-[16px] rounded-tl-[0] rounded-tr-[0] w-[100%]">
                      <Text className="font-medium lg:mb-[18px] xl:mb-[20px] mb-[23.29px] 2xl:mb-[23px] 3xl:mb-[27px] lg:ml-[252px] xl:ml-[288px] ml-[324px] 3xl:ml-[389px] lg:mt-[19px] xl:mt-[22px] mt-[25px] 3xl:mt-[30px] text-bluegray_702 text-center lg:text-fs10 xl:text-fs12 text-fs14 3xl:text-fs16">{`Cancel`}</Text>
                      <Button
                        className="common-pointer bg-deep_purple_A200_14 border-bw font-medium xl:mb-[10px] mb-[11.29px] 2xl:mb-[11px] 3xl:mb-[13px] lg:mb-[8px] lg:ml-[15px] xl:ml-[17px] ml-[20px] 3xl:ml-[24px] xl:mr-[10px] mr-[12px] 3xl:mr-[14px] lg:mr-[9px] lg:mt-[10px] xl:mt-[11px] mt-[13px] 3xl:mt-[15px] xl:px-[10px] px-[12px] 3xl:px-[14px] lg:px-[9px] lg:py-[10px] xl:py-[11px] py-[13px] 3xl:py-[15px] rounded-radius8 text-center text-deep_purple_A200 lg:text-fs10 xl:text-fs12 text-fs14 3xl:text-fs16 w-[13%]"
                        onClick={handleNavigate2}
                      >{`Apply`}</Button>
                    </Row>
                  </Stack>
                </Stack>
                <Column className="absolute inset-x-[0] items-start justify-start mx-[auto] top-[8%] w-[27%]">
                  <Row className="items-center justify-start mr-[10px] 3xl:mr-[12px] lg:mr-[7px] xl:mr-[8px] w-[53%]">
                    <Row className="items-center justify-start w-[49%]">
                      <Text className="font-medium lg:ml-[6px] xl:ml-[7px] ml-[8px] 3xl:ml-[9px] lg:my-[6px] xl:my-[7px] my-[8px] 3xl:my-[9px] text-bluegray_702 lg:text-fs10 xl:text-fs11 text-fs13 3xl:text-fs15 text-left">{`ASC`}</Text>
                      <Image
                        src="img_icon24arrowu.svg"
                        className="lg:h-[16px] xl:h-[18px] h-[20px] 2xl:h-[21px] 3xl:h-[25px] xl:ml-[3px] lg:ml-[3px] ml-[4px] lg:mr-[4px] xl:mr-[5px] mr-[6px] 3xl:mr-[7px] lg:my-[4px] xl:my-[5px] my-[6px] 3xl:my-[7px] object-contain lg:w-[15px] xl:w-[17px] w-[20px] 3xl:w-[24px]"
                        alt="icon24arrowu"
                      />
                    </Row>
                    <Row className="items-center justify-center xl:ml-[1px] lg:ml-[1px] ml-[2px] w-[50%]">
                      <Text className="font-medium lg:ml-[6px] xl:ml-[7px] ml-[8px] 3xl:ml-[9px] lg:my-[6px] xl:my-[7px] my-[8px] 3xl:my-[9px] text-bluegray_702 lg:text-fs10 xl:text-fs11 text-fs13 3xl:text-fs15 text-left">{`DSC`}</Text>
                      <Image
                        src="img_icon24chevron.svg"
                        className="lg:h-[16px] xl:h-[18px] h-[20px] 2xl:h-[21px] 3xl:h-[25px] xl:ml-[3px] lg:ml-[3px] ml-[4px] lg:mr-[4px] xl:mr-[5px] mr-[6px] 3xl:mr-[7px] lg:my-[4px] xl:my-[5px] my-[6px] 3xl:my-[7px] object-contain lg:w-[15px] xl:w-[17px] w-[20px] 3xl:w-[24px]"
                        alt="icon24chevron"
                      />
                    </Row>
                  ...
                  <Column className="lg:mt-[6px] xl:mt-[7px] mt-[8px] 3xl:mt-[9px] w-[100%]">
                    <Row className="items-center justify-end w-[100%]">
                      <Text className="font-apercupro font-medium lg:ml-[6px] xl:ml-[7px] ml-[8px] 3xl:ml-[9px] lg:my-[4px] xl:my-[5px] my-[6px] 3xl:my-[7px] text-bluegray_900 lg:text-fs10 xl:text-fs11 text-fs13 3xl:text-fs15 text-left">{`Spend`}</Text>
                      <div className="3xl:ml-[9px] bg-transparent border-0 lg:ml-[6px] ml-[8px] w-[43%] xl:ml-[7px] input-wrap">
                        <Image
                          src="img_vector.svg"
                          className="absolute h-[6.36px] right-[14px] bg-transparent border-0 lg:h-[5px] lg:right-[10px] lg:inset-y-[7px] xl:h-[6px] xl:right-[12px] xl:inset-y-[8px] 2xl:h-[7px] 2xl:inset-y-[9px] 3xl:h-[8px] 3xl:right-[16px] 3xl:inset-y-[11px] inset-y-[9.625px]"
                          alt="Vector"
                        />
                        <Input
                          className="bg-gray_100 placeholder:bg-transparent border-0 font-apercupro font-medium lg:pl-[6px] xl:pl-[7px] pl-[8px] 3xl:pl-[9px] lg:pr-[23px] xl:pr-[27px] pr-[30.36px] 2xl:pr-[30px] 3xl:pr-[36px] 3xl:py-[11px] lg:py-[7px] xl:py-[8px] py-[9.625px] 2xl:py-[9px] rounded-radius8 placeholder:text-bluegray_900 text-bluegray_900 lg:text-fs10 xl:text-fs11 text-fs13 3xl:text-fs15 text-left w-[100%]"
                          name="more than"
                          placeholder={`more than`}
                        ></Input>
                      </div>
                      <Button className="bg-gray_100 border-bw font-alata font-normal lg:ml-[6px] xl:ml-[7px] ml-[8px] 3xl:ml-[9px] my-[1px] not-italic outline outline-[1px] outline-deep_purple_A100 lg:pl-[6px] xl:pl-[7px] pl-[8px] 3xl:pl-[9px] 3xl:py-[10px] lg:py-[6px] xl:py-[7px] py-[8.625px] 2xl:py-[8px] rounded-radius8 shadow-bs text-bluegray_900 lg:text-fs10 xl:text-fs11 text-fs13 3xl:text-fs15 text-left w-[32%]">{`$700`}</Button>
                    </Row>
                  </Column>
                </Column>
              </Stack>
              ...
              <Stack className="lg:h-[570px] xl:h-[652px] h-[732px] 2xl:h-[733px] 3xl:h-[879px] w-[12%]">
                <Column className="absolute inset-[0] w-[100%]">
                  <Stack className="lg:h-[486px] xl:h-[556px] h-[624px] 2xl:h-[625px] 3xl:h-[750px] w-[100%]">
                    <Stack className="absolute lg:h-[486px] xl:h-[556px] h-[624px] 2xl:h-[625px] 3xl:h-[750px] inset-[0] w-[100%]">
                      <div className="absolute bg-gray_51 lg:h-[38px] xl:h-[43px] h-[48px] 2xl:h-[49px] 3xl:h-[58px] top-[0] w-[100%]"></div>
                      <Line className="absolute h-[1px] top-[8%] w-[100%]" />
                      <Line className="absolute h-[1px] top-[0] w-[100%]" />
                      <Image
                    ...
                    <Text className="absolute font-bold left-[11%] text-bluegray_702 xl:text-fs10 text-fs12 3xl:text-fs14 lg:text-fs9 text-left top-[3%]">{`Estimated conversion`}</Text>
                  </Stack>
                  <Image
                    src="img_rowstablecust_5.svg"
                    className="lg:h-[28px] xl:h-[33px] h-[36px] 2xl:h-[37px] 3xl:h-[44px] object-cover w-[100%]"
                    alt="rowstablecust"
                  />
                  <Image
                    src="img_rowstablecust_1.svg"
                ...
                <Image
                  src="img_button.svg"
                  className="absolute bottom-[9%] lg:h-[28px] xl:h-[33px] h-[36px] 2xl:h-[37px] 3xl:h-[44px] object-contain right-[10%] rounded-radius58 w-[25%]"
                  alt="Button"
                />
              </Stack>
            </Row>
